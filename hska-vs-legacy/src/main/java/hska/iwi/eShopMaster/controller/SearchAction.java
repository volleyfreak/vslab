...
import hska.iwi.eShopMaster.model.businessLogic.manager.impl.CategoryMicroserviceAdapter;
import hska.iwi.eShopMaster.model.businessLogic.manager.impl.ProductMicroserviceAdapter;
...
public class SearchAction extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		if(user != null){
			...
			ProductManager productManager = new ProductMicroserviceAdapter();
